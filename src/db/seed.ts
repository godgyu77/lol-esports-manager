...
const TRAIT_TO_TAGS: Record<string, string[]> = {
  ...
  PLAYMAKER: ['engage', 'assassin', 'teamfight'],
  CLUTCH: ['teamfight', 'scaling'],
  BIG_GAME_PLAYER: ['teamfight', 'scaling'],
  VISIONARY: ['utility', 'teamfight'],
  SMART_JUNGLE: ['utility', 'engage'],
  TEAMFIGHT_GLADIATOR: ['teamfight', 'scaling'],
  POKE_MASTER: ['poke', 'mage'],
  ROAMING_GOD: ['roam', 'engage'],
