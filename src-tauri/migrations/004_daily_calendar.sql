-- 시즌에 현재 날짜 추가
ALTER TABLE seasons ADD COLUMN current_date TEXT NOT NULL DEFAULT '2026-01-12';
ALTER TABLE seasons ADD COLUMN start_date TEXT NOT NULL DEFAULT '2026-01-12';
